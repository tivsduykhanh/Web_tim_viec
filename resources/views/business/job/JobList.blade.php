				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="/business/job"> Đăng tin</a></p>
						</div>											
					</div>
				</div>
			</section>
						...
						<div class="col-lg-8 post-list">
							...
							<div class="single-post d-flex flex-row">
								<button  class="btn btn-primary" href="#">
									...
									<svg xmlns="#" width="16" height="16" fill="currentColor" class="bi bi-clipboard-plus" viewBox="0 0 16 16">
